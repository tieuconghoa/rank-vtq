...
const cum10 = "";
const cum11 = "116,117,118,119,120,121,122,123,124,125,126,127,128,129,130";
const cum12 = "";
const cum13 = "131,132,133,134,135,136,137,138,139,140";
const cum14 = "141,142,143,144,145";
...
app.get("/api/:id", async(req, res) => {
    ...
    res.json(await get_data(encodeURIComponent(array[id - 1])));
